      ...
      componentDidMount(){
        ...
        if(cookies.get('valid')!=1){
          ...
          .then( e => {
            ...
            fetch(configRest.autenticacao + '/temConsulta?e='+ this.state.email + "&d=" + this.state.date)
            .then(response => response.json())
            .then(data => {
              if(data.valid === 1){
                                                ...
                                                <div className="col-md-12" style={{width:"1000px",backgroundColor:"#d1f4ff"}}>
                                                  ...
                                                  <h3>Tem a certeza que pertende adicionar esta consulta com {data}?</h3>
                                                      ...
                                                      <button style={{backgroundColor:"#30c830ba"}} onClick={() => {
                                                              ...
                                                              fetch(configRest.autenticacao + '/jwt?e='+ data )
                                                              .then(response => response.json())
                                                              .then(data1 => {
                                                                ...
                                                                .then(data2 => {
                                                                  if( data2.ics != undefined){
                                                                    fetch(configRest.autenticacao + '/addConsulta?e='+ this.state.email + "&d=" + this.state.date + "&m=" + data + "&i="+  data2.ics)
